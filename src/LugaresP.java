public class LugaresP extends Quito{
    String direccion;
    String restaurante;
    String time;
    int calificacion;
    ...
    public LugaresP(String foodName, String chefName, String IngredentsNumber, String Sabor, String extra, String juice, String dresser, double costs, String year, String direccion, String restaurante, String time, int calificacion) {
